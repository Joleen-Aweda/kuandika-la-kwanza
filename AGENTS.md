...
**Kuandika** — Hiki ni kitabu cha mwanafunzi cha somo la Kuandika kwa Darasa la Kwanza, kilichoandaliwa na Taasisi ya Elimu Tanzania kwa ajili ya kuwajengea watoto stadi za awali za uandishi. Kinafundisha hatua kwa hatua kuchora, kuandika herufi ndogo na kubwa za irabu na konsonanti, herufi mwambatano, silabi, maneno, sentensi na matumizi ya alama za uandishi, hivyo kinafaa kwa kiwango cha elimu ya awali hadi mwanzo wa shule ya msingi. Kitabu hiki kimetoka Tanzania na kimeandikwa kwa Kiswahili, kikiwa na mtazamo wa ujifunzaji wa vitendo kupitia kufuatisha maumbo, mazoezi mengi, picha na shughuli za kuandika kwa usahihi.
...
├── Kuandika-Std-1-Final.db                    # SQLite database (pipeline state)
├── Kuandika-Std-1-Final.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg006_im001": "Msimbo wa QR wa kufikia maktaba mtandao kwa kujifunza zaidi.",
  "gl001": "alama",
  "gl001_def": "ishara inayotumika katika maandishi kuonyesha maana au mpangilio.",
  "qz001_que": "Majina mengi yaliyoandikwa kwenye ukurasa yanaanza na herufi gani?",
  "qz001_o0": "1) D",
  "qz001_o0_exp": "❌ Jaribu tena. Majina kwenye zoezi hili hayaanzi zaidi na herufi D, bali A."
}
```
...
```json
{
  "alama": {
    "word": "alama",
    "definition": "ishara inayotumika katika maandishi kuonyesha maana au mpangilio.",
    "variations": ["alama za uandishi","alama"],
    "emoji": "❗❓📍"
  }
}
```
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Majina mengi yaliyoandikwa kwenye ukurasa yanaanza na herufi gani?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Jaribu tena. Majina kwenye zoezi hili hayaanzi zaidi na herufi D, bali A." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) D</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `Kuandika-Std-1-Final.pdf` |
| Pipeline database | `Kuandika-Std-1-Final.db` (SQLite) |
