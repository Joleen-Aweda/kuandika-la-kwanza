...
OVERLAY_POSITIONS: dict[str, list[dict] | dict] = {
    ...
    "16": {
        **positioned(VIDEO_IRABU, 220, line_count=6, rect_x=175, rect_width=440, text_x=185, first_line_y=252, gap=0, fill=WHITE, align="center"),
        "height": 230,
    },
    ...
    "19": [
        correction("pg019_n0008", 506, line_count=2),
        correction("pg019_n0010", 672, line_count=2),
        correction("pg019_n0024", 850, line_count=2),
    ],
    ...
    "54": {
        **positioned(VIDEO_SMALL_CONSONANTS, 245, line_count=6, rect_x=345, rect_width=440, text_x=355, first_line_y=277, gap=0, fill=WHITE, align="center"),
        "height": 230,
    },
    "55": [
    ...
    "57": [
        correction("pg057_n0005", 306, line_count=2, layout_offset=30, gap=0),
        positioned(write_instruction("ya irabu", "E", 6, 1, 5), 447, line_count=2, layout_offset=150, gap=0),
        positioned("Andika herufi kubwa E ikifuatiwa na herufi ndogo e kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 615, line_count=2, layout_offset=150, gap=0),
    ],
    "58": [
        correction("pg058_n0018", 837, line_count=2),
        correction("pg058_n0020", 1012, line_count=2),
    ],
    "60": [
        correction("pg060_n0004", 283, line_count=2, layout_offset=30, gap=0),
        positioned(write_instruction("ya irabu", "O", 6, 1, 3, 5), 424, line_count=2, layout_offset=150, gap=0),
        positioned("Andika herufi kubwa O ikifuatiwa na herufi ndogo o kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 590, line_count=2, layout_offset=150, gap=0),
    ],
    "61": [
        correction("pg061_n0023", 711, line_count=2, layout_offset=30, gap=0),
        positioned(write_instruction("ya irabu", "U", 6, 1, 3, 6), 848, line_count=2, layout_offset=150, gap=0),
        positioned("Andika herufi kubwa U ikifuatiwa na herufi ndogo u kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 1017, line_count=2, layout_offset=150, gap=0),
    ],
    "63": [
        correction("pg063_n0013", 682, line_count=2, layout_offset=30, gap=0),
        positioned(write_instruction("ya konsonanti", "B", 6, 1, 2), 829, line_count=2, layout_offset=150, gap=0),
        positioned("Andika herufi kubwa B ikifuatiwa na herufi ndogo b kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 999, line_count=2, layout_offset=150, gap=0),
    ],
    "65": [
        correction("pg065_n0005", 306, line_count=2, layout_offset=30, gap=0),
        positioned(write_instruction("ya konsonanti", "M", 6, 1, 3, 4), 438, line_count=2, layout_offset=150, gap=0),
        positioned("Andika herufi kubwa M ikifuatiwa na herufi ndogo m kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 605, line_count=2, layout_offset=150, gap=0),
    ],
    "66": [
        correction("pg066_n0032", 834, line_count=2, layout_offset=20, gap=0),
        positioned(write_instruction("ya konsonanti", "K", 6, 1, 3), 955, line_count=2, layout_offset=140, gap=0),
        positioned("Andika herufi kubwa K ikifuatiwa na herufi ndogo k kwa pamoja kisha, andika tena herufi hizo kwa nafasi na ujaze mstari.", 1175, line_count=2, layout_offset=140, gap=0),
    ],
    "68": [
        correction("pg068_n0005", 297, line_count=2),
        correction("pg068_n0009", 475, line_count=3),
    ],
    "69": correction("pg069_n0019", 940, line_count=2),
    "70": correction("pg070_n0002", 135, line_count=2),
    "72": [
        correction("pg072_n0015", 544, line_count=2, layout_offset=0),
        correction("pg072_n0019", 720, line_count=2, layout_offset=90),
    ],
    "74": [
        {
            **correction("pg074_n0005", 305, line_count=3),
            "oldBottom": 340,
        },
        correction("pg074_n0009", 492, line_count=3),
    ],
    ...
    "81": [
        {
            **correction("pg081_n0013", 551, line_count=2),
            "oldBottom": 585,
        },
        correction("pg081_n0023", 726, line_count=2),
    ],
    ...
    "97": [
        ...
        {
            **positioned(VIDEO_CAPITAL_CONSONANTS, 735, line_count=6, rect_x=360, rect_width=430, text_x=370, first_line_y=767, gap=0, fill=WHITE, align="center"),
            "height": 230,
        },
    ],
